...
- will repeatedly call a function for a set number of times with a fixed time delay between each call. 
- clear will stop the interval from running. 
...
### updated todo mini project 
- gives examples of update, delete 
...
- error checking example from the random user generator example
...
## Async Await: 
- cleaner and reads like sync code 
